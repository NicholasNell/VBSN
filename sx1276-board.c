...
const struct Radio_s Radio = { SX1276Init, SX1276GetStatus, SX1276SetModem,
		...
		SX1276ReadRssi, spi_write_rfm, spi_read_rfm, SX1276WriteBuffer,
...
void SX1276IoInit(void) {
	...
	RADIO_RESET, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1);
	gpio_init(&SX1276.NSS, RADIO_NSS, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL,
			0);
	spi_open();

	gpio_init(&SX1276.DIO0,
	RADIO_DIO_0, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
	gpio_init(&SX1276.DIO1,
	RADIO_DIO_1, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
	gpio_init(&SX1276.DIO2,
	RADIO_DIO_2, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
	gpio_init(&SX1276.DIO3,
	RADIO_DIO_3, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
...
void SX1276IoDeInit(void) {
	...
	gpio_init(&SX1276.DIO0,
	RADIO_DIO_0, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
	gpio_init(&SX1276.DIO1,
	RADIO_DIO_1, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
	gpio_init(&SX1276.DIO2,
	RADIO_DIO_2, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
	gpio_init(&SX1276.DIO3,
	RADIO_DIO_3, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
