...
const struct Radio_s Radio = { SX1276Init, SX1276GetStatus, SX1276SetModem,
		...
		SX1276ReadRssi, spiWrite_RFM, spiRead_RFM, SX1276WriteBuffer,
		SX1276ReadBuffer, SX1276SetMaxPayloadLength, SX1276SetPublicNetwork,
		SX1276GetWakeupTime,
...
void SX1276IoInit(void) {
	...
	GpioInit(&SX1276.Reset, RADIO_RESET, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL,
			1);
	GpioInit(&SX1276.NSS, RADIO_NSS, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
	spi_open();

	GpioInit(&SX1276.DIO0, RADIO_DIO_0, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP,
			0);
	GpioInit(&SX1276.DIO1, RADIO_DIO_1, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP,
			0);
	GpioInit(&SX1276.DIO2, RADIO_DIO_2, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP,
			0);
//	GpioInit(&SX1276.DIO3, RADIO_DIO_3, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP,
//			0);
...
void SX1276IoDeInit(void) {
	...
	GpioInit(&SX1276.DIO0, RADIO_DIO_0, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL,
			0);
	GpioInit(&SX1276.DIO1, RADIO_DIO_1, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL,
			0);
	GpioInit(&SX1276.DIO2, RADIO_DIO_2, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL,
			0);
	GpioInit(&SX1276.DIO3, RADIO_DIO_3, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL,
			0);
